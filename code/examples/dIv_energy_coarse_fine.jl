...
div2 = plot(tspan[1]:analysis_timestep:tspan[2], div_rk[1:(analysis_points - 1), 3],
            label = "p = 2, Runge-Kutta", xlabel = "time", ylabel = "divergence",
            linestyle = :dash)
plot!(div2, tspan[1]:analysis_timestep:tspan[2], div_implicit[1:(analysis_points - 1), 3],
      label = "p = 2, Crank-Nicolson", linestyle = :dot)
plot!(div2, tspan[1]:analysis_timestep:tspan[2], div_rk[1:(analysis_points - 1), 4],
      label = "p = 3, Runge-Kutta", linestyle = :dashdot)
plot!(div2, tspan[1]:analysis_timestep:tspan[2], div_implicit[1:(analysis_points - 1), 4],
      label = "p = 3, Crank-Nicolson", linestyle = :dashdotdot)
...
en2 = plot(tspan[1]:analysis_timestep:tspan[2],
           energy_rk[1:(analysis_points - 1), 3] .- energy_rk[1, 3],
           label = "p = 2, Runge-Kutta", xlabel = "time", ylabel = "energy error",
           linestyle = :dash, legend = :bottomleft)
plot!(en2, tspan[1]:analysis_timestep:tspan[2],
